...
import { ApprovalQueue as ApprovalQueueImpl } from '../services/approval-queue.js';
...
export class Agent {
  ...
  private _scheduler?: import('../services/scheduler.js').Scheduler;
   ...
   */
  setScheduler(scheduler: import('../services/scheduler.js').Scheduler): void {
